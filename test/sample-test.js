...
describe("VinciNFT", function () {
  it("Should test Merkle Root", async function () {
    ...
    expect(await vincinft.tokenURI(1)).to.equal("https://ipfs.io/ipfs/bafybeiedzibr7fubelyk5wxa6eaclcy3pwayrtrmo4vxuos7appi7euuiq/1.json");
    expect(await vincinft.contractURI()).to.equal("https://ipfs.io/ipfs/bafybeiedzibr7fubelyk5wxa6eaclcy3pwayrtrmo4vxuos7appi7euuiq/1.json");
